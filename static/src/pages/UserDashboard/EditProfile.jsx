                    ...
                    <Col sm="8">
                        <Container fluid>
                            ...
                            <Form onSubmit={this.onSubmit}>
                                ...
                                <Button color="danger" onClick={this.toggle}>Guardar Cambios</Button>
                                <Modal isOpen={this.state.modal} fade={false} toggle={this.toggle} >
                                    <ModalHeader toggle={this.toggle} close={closeBtn}>Editar mis datos</ModalHeader>
                                    <ModalBody>

                                        <FormGroup row style={{textAlign:'center', offset:2}}>
                                            <Label for="passwordCheck" sm={4} style={{textAlign:'center'}}>
