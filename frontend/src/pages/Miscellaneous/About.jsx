  ...
  const team =
    ...
    return (
      <Col>
        ...
        <p style={{textAlign:'center', color:'rgb(151, 135, 143)'}}>{el.employment}</p>
      </Col>
    )});
    const formerteam =
    ...
    <Container>
          ...
          <Row>
            <Col>
              ...
              <p style={{textAlign: 'justify', textJustify: 'inter-word', marginTop:'2em'}}>
                ...
                rescatando y sistematizando dicha información para así permitir a la comunidad imbuirse de la trayectoria
                que ha construido el carácter e identidad de la Escuela de InJeniería de la Universidad de Chile.
                Toda persona perteneciente a la comunidad universitaria, ya sea alumno, ex alumno, funcionario, académico o externo, 
                es libre de aportar el material que desee. Si tienes dudas de qué contenido puedes subir, los derechos de propiedad 
                u otras inquietudes, puedes solucionarlas en la sección
      ...
      <Row ref={leit}>
        <Col>
          ...
          <p>La Plataforma es desarrollada por el equipo multidisciplinario LEIT (Laboratorio Estudiantil de Info Tecnologías) 
            con la ayuda de distintas personas pertenecientes a la facultad de Ciencias Físicas y Matemáticas de la Universidad de Chile. </p>
      ...
      <Row ref={joinUs}>
        <Col>
          <h2>Forma parte</h2>
          <p>
            Como equipo LEIT, queremos impulsar a alumnos de distintas áreas a desarrollar proyectos en conjunto con la Universidad de Chile;
            pudiendo desarrollar nuevas herramientas para su futuro.
            Si quieres ser parte, puedes enviarnos un mensaje en la página de
            <Link to="/misc/resources/contact-us" style={{marginLeft:'0.2em'}}>
              Contacto.
            </Link>
          </p>
        </Col>
