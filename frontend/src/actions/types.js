...
// header
export const NOTIFICATIONS_RECOVERED = "NOTIFICATIONS_RECOVERED";

// PHOTOS
export const RECOVERED_PHOTOS = "RECOVERED_PHOTOS";
export const EMPTY_PHOTOS = "EMPTY_PHOTOS";
export const PHOTO_RESET_NB_OPS = "PHOTO_RESET_NB_OPS";
export const EDIT_PHOTO_UPDATING = "EDIT_PHOTO_UPDATING";
...
export const PHOTO_DETAILS_LOADED = "PHOTO_DETAILS_LOADED";
...
export const REPORT_UPDATING = "REPORT_UPDATING";
export const REPORT_CENSORING = "REPORT_CENSORING";
export const REPORT_DISCARDING = "REPORT_DISCARDING";
export const REPORT_UPDATED = "REPORT_UPDATED";
export const REPORT_UPDATED_ERROR = "REPORT_UPDATED_ERROR";
...
export const APPROVING_TAGSUGGESTION = "APPROVING_TAGSUGGESTION"
export const APPROVED_TAGSUGGESTION = "APPROVED_TAGSUGGESTION"
export const APPROVED_TAGSUGGESTION_ERROR = "APPROVED_TAGSUGGESTION_ERROR"
...
export const USER_PHOTOS_LOADED = "USER_PHOTOS_LOADED";
export const USER_PHOTOS_ERROR = "USER_PHOTOS_ERROR";
...
export const USER_RECOVERED_NOTIFICATIONS = "USER_RECOVERED_NOTIFICATIONS";
export const USER_RECOVERED_NOTIFICATIONS_ERROR = "USER_RECOVERED_NOTIFICATIONS_ERROR";
...
export const RESET_UNREGISTERED_UPLOAD = "RESET_UNREGISTERED_UPLOAD";
...
export const GUEST_VERIFY = "GUEST_VERIFY";
export const GUEST_VERIFY_ERROR = "GUEST_VERIFY_ERROR";
